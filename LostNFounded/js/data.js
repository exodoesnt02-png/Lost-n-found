...
const DB = (() => {
  ...
  const SEED = {
    ...
    locations: [
      ...
      { name: 'Bacolod', lat: 10.6761, lng: 122.9514 },
      { name: 'Bago', lat: 10.5389, lng: 122.8367 },
      { name: 'Binalbagan', lat: 10.1967, lng: 122.8656 },
      { name: 'Cadiz', lat: 10.9544, lng: 123.3058 },
      { name: 'Calatrava', lat: 10.5939, lng: 123.4764 },
      { name: 'Candoni', lat: 9.8278, lng: 122.6422 },
      { name: 'Cauayan', lat: 9.9725, lng: 122.6242 },
      { name: 'Don Salvador Benedicto', lat: 10.5772, lng: 123.2206 },
      { name: 'Enrique B. Magalona', lat: 10.8769, lng: 122.9814 },
      { name: 'Escalante', lat: 10.8411, lng: 123.4992 },
      { name: 'Himamaylan', lat: 10.1000, lng: 122.8700 },
      { name: 'Hinigaran', lat: 10.2742, lng: 122.8519 },
      { name: 'Hinoba-an', lat: 9.6014, lng: 122.4694 },
      { name: 'Ilog', lat: 10.0239, lng: 122.7681 },
      { name: 'Isabela', lat: 10.2036, lng: 122.9881 },
      { name: 'Kabankalan', lat: 9.9903, lng: 122.8164 },
      { name: 'La Carlota', lat: 10.4253, lng: 122.9225 },
      { name: 'La Castellana', lat: 10.3231, lng: 123.0186 },
      { name: 'Manapla', lat: 10.9558, lng: 123.1239 },
      { name: 'Moises Padilla', lat: 10.2703, lng: 123.0739 },
      { name: 'Murcia', lat: 10.6067, lng: 123.0403 },
      { name: 'Pontevedra', lat: 10.3678, lng: 122.8703 },
      { name: 'Pulupandan', lat: 10.5189, lng: 122.8033 },
      { name: 'Sagay', lat: 10.8961, lng: 123.4153 },
      { name: 'San Carlos', lat: 10.4825, lng: 123.4183 },
      { name: 'San Enrique', lat: 10.4122, lng: 122.8547 },
      { name: 'Silay', lat: 10.7978, lng: 122.9731 },
      { name: 'Sipalay', lat: 9.7500, lng: 122.4019 },
      { name: 'Talisay', lat: 10.7372, lng: 122.9672 },
      { name: 'Toboso', lat: 10.7156, lng: 123.5172 },
      { name: 'Valladolid', lat: 10.4614, lng: 122.8242 },
      { name: 'Victorias', lat: 10.8961, lng: 123.0725 },
    ],
    session: null
  };
  ...
  const init = () => {
    // Always reset and reinitialize with current SEED data
